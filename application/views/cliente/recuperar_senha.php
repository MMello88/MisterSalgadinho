    ...
    <div class="py-3 text-center">
      ...
      <?php if (empty($hash)) : ?>
        ...
        <?= form_open('clientes/recuperar'); ?>
          ...
          <hr class="mb-4">
          <button class="btn btn-primary btn-lg btn-block" type="submit">Solicitar Recuperação de Senha</button>
        </form>
      ...
      <?php else : ?>
        ...
        <?= form_open("clientes/recuperar/$hash"); ?>
          ...
          <hr class="mb-4">
          <button class="btn btn-primary btn-lg btn-block" type="submit">Alterar a Senha</button>
        </form>
      <?php endif; ?>
    </div>
    <!-- fim do Titulo -->
