    <footer class="footer">
      <div class="container">
            ...
            <address class="text-light">
              ...
              <img class="icon mr-2" src="<?php echo base_url("assets/ico/social/location-pin_light.svg"); ?>" alt="Localização">R. Prudente Moraes n° 532<br>
              ...
              <img class="icon mr-2" src="<?php echo base_url("assets/ico/social/phone.svg"); ?>" alt="Celular">            Telefone (16) 3325-0364<br>
